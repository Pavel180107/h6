...
<head>
    ...
    <style>
        /* Дополнительные стили для админ-панели (совместимые с основным CSS) */
        .admin-edit-form {
            background: #1a1a1a;
        ...
        .edit-link { color: #a3bffa; }
        .edit-link:hover { color: #c4d0a8; }
        .delete-link { color: #e67e22; }
        .delete-link:hover { color: #ffaa77; }
        .back-link {
            text-align: center;
            margin-top: 30px;
        }
    ...
    <div class="table-responsive">
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="panel.php?edit=<?= $app['id'] ?>" class="edit-link">✏️ Ред.</a> |
                    <a href="panel.php?delete=<?= $app['id'] ?>" onclick="return confirm('Удалить анкету №<?= $app['id'] ?>?')" class="delete-link">🗑 Удалить</a>
                </td>
            </tr>
            <?php endforeach; ?>
